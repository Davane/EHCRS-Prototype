				  			...
				  			<div class="panel panel-default">
				  				<div class="panel-body">
                                       ...
                                       <div class="col-md-2" >
                                           ...
                                           <?php if (isset($_POST['submit']) && $_POST['submit'] === 'add-vital' && $_POST['med_his_id'] == $row_med_his['med_his_id']): ?>
                								...
                								<form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                									...
                									<div class="form-group">
                										...
                										<div style="width: 100px; "class="col-md-1 col-xs-1">
                											<input type="date" class="form-control input-sm" name="urine" placeholder="urinalysis">
                										</div>
    									...
    									<form action="<?php $_SERVER['PHP_SELF'];?>" method="post">
    										...
    										<div class="form-group">
    											<div class="col-md-3 col-xs-1">
    												<input type="date" class="form-control input-sm" style="width: 400px" name="symptom" placeholder="Signs & Symptons">
    											</div>
                                                        ...
                                                        <form  action="<?php $_SERVER['PHP_SELF'];  ?>" method="post">
        											      ...
        											      <tr>
                                                              ...
                                                              <?php if(!empty($_POST) && $_POST['submit'] === 'edit-med' && $_POST['id-med'] == $row_med['med_id']) { ?>
                                                                  ...
                                                                  <td><select name="type" class="form-control custom-select">
                                                                  ...
                                                                  <td><select name="category" class="form-control custom-select">
                                                            ...
                                                            <td><?php echo isset($row_med['hospital']) ? 'Dr. ' .  $row_med['hospital'] : '' ; ?></td>
